...
HQ is a static blog/personal website built with Astro 5, deployed to Cloudflare Workers. It uses Tailwind CSS v4 with DaisyUI for styling and supports Markdown/MDX content.
...
3. Grammar check via `./scripts/grammar-check.sh`
